...
/**
 * this is a constant file having all required URL for API testing
 * @author Asus
 */
public class BaseURLs {
	...
	/*
	 * Flow-User: Preparing required URL
	 */
	...
	/*
	 * Flow-Store: Preparing required URL
	 */
	
	
	/*
	 * Flow-Pet: Preparing required URL
	 */
}
